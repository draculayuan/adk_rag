...
class EmbeddingGenerator:
    ...
    def generate_embeddings(self, chunks: List[Dict[str, Any]], chunk_batch_size=20) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for i in range(0, len(texts), chunk_batch_size):
                ...
                batch_emb = self.embedding_model.get_embeddings(batch) # returns list/array
