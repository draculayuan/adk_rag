...
rag_agent = LlmAgent(
    ...
    instruction=(
        """
        You are a question answering agent who will answer user's question by retrieving knowledge from the knowledge base by running 'retrieve_documents(query)' function; Please strictly answer user's question based on the knowledge, and remember to cite the source of the knowledge.\n
